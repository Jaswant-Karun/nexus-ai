...
class _WorkflowListScreenState extends State<WorkflowListScreen> {
  ...
  void _triggerWorkflow(Map<String, dynamic> wf) {
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(wf['name'] as String, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                        Text('Trigger: ${wf['trigger']}', style: const TextStyle(fontSize: 11, color: Color(0xff6c7890))),
                      ],
                    ),
                  ),
                ],
              ...
              const Text('Execute manual run with mock payload?', style: TextStyle(fontSize: 13, color: Color(0xff6c7890))),
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(wf['name'] as String, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                              const SizedBox(height: 2),
                              Text('Trigger: ${wf['trigger']}', style: const TextStyle(color: Color(0xff6c7890), fontSize: 11)),
                            ],
                          ),
                        ),
                        Container(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('Last: ${wf['lastRun']}', style: const TextStyle(fontSize: 11, color: Color(0xff6c7890))),
                          Text('Total: ${wf['runs']}', style: const TextStyle(fontSize: 11, color: Color(0xff6c7890))),
